...
SECTIONS = [
    ...
    (
        ...
        [
            ...
            "The visibility and request amounts are represented as nonnegative integers, or as all. For example, a value of 2 means two peers. Values larger than the number of available peers are capped at all available peers.",
